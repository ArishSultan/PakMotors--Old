...
{
    public partial class CreditSaleForm : Form
    {
        ...
        public CreditSaleForm()
        {
            InitializeComponent();

            panel18.Location = new Point(ClientSize.Width / 2 - panel18.Size.Width / 2, panel18.Location.Y);

            carSaleDate.Enabled = false;

            CarFiller = new object[] { serial, purchaseAmount, PBO, model, color, engine, variant, chassis, invoiceRecieved, invoiceDatePicker, recievedDatePicker, horsePower, registration, flowLayoutPanel1, invoiceDelivered, InvoiceFlag, RecievedFlag, buyerName, buyerCNIC, carTotalAmmount, carSaleDate, carNote, form };
            ...
            form.Image = witness2ThumbBox.Image = witness2PictureBox.Image = witness2SignatureBox.Image = null;
        ...
        public CreditSaleForm(int id) : this()
        {
            isCarUpdate = true;
            isBuyerUpdate = true;
            isSellerUpdate = true;
        ...
        private void BuyerCNIC_KeyDown(object sender, KeyEventArgs e) { if (e.KeyCode == Keys.Enter && buyerCNIC.Text != "     -       -") AutoCompleteCNIC(buyerCNIC.Text, ref Buyer, BuyerFiller, ref isBuyerUpdate); Buyer.IsBuyer = true; }
        ...
        private void Witness1CNIC_KeyDown(object sender, KeyEventArgs e) { if (e.KeyCode == Keys.Enter && witness1CNIC.Text != "     -       -") AutoCompleteCNIC(witness1CNIC.Text, ref Witness1, Witness1Filler, ref isWitness1Update); Witness1.IsWitness = true; }
        private void Witness2CNIC_KeyDown(object sender, KeyEventArgs e) { if (e.KeyCode == Keys.Enter && witness2CNIC.Text != "     -       -") AutoCompleteCNIC(witness2CNIC.Text, ref Witness2, Witness2Filler, ref isWitness2Update); Witness2.IsWitness = true; }
        ...
        private void Submit_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                Car.CashSaleFlag = false;
                Car.CreditSaleFlag = true;
        ...
        {
            Utils.ImageHandling.AddImageWithFilePicker(form);
        }
        ...
        private void CreditSaleForm_SizeChanged(object sender, EventArgs e)
        {
            panel18.Location = new Point(ClientSize.Width / 2 - panel18.Size.Width / 2, panel18.Location.Y);
        }
