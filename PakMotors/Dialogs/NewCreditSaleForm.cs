...
{
    public partial class NewCreditSaleForm : Form
    {
        long sum = 0;
        ...
        public NewCreditSaleForm(int id) : this()
        {
            this._Car = new Models.Car();
            this._Car.CashSaleFlag = false;
        ...
        private void SellerView_Click(object sender, EventArgs e)
        {
            ...
            if (Dialogs.CreatePerson.RecentPerson != null) _Seller = Dialogs.CreatePerson.GetRecentPerson();
        ...
        private void HandleSubmission()
        {
            ...
            if (_Car.CarTransactions.Count < 1)
            {
                MessageBox.Show("Please Provide Atleast 2 Credit Plan Rows");
                return;
            }

            try
            {
                _Car.CashSaleFlag = false;
                _Car.CreditSaleFlag = true;
        ...
        private void NewCreditSaleForm_Load(object sender, EventArgs e)
        {
        }
        ...
        private void WitnessView_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You have selected no ");
                return;
            }
